                ...
                (function () {
                    app = new Vue({
                        ...
                        data: {
                            ...
                            { title: '学生', render: (h, params) => { return params.row.student.realName } },
...
//                            { title: '正确数量', render: (h, params) => { return renderNumberWithThousands(h, params.row.rightQty); } },
                            { title: '错题数量', render: (h, params) => { return params.row.errorQty; } },
                            { title: '成绩', render: (h, params) => { return params.row.score; } },
