		...
		<div style="padding: 10px;" id="app">
		    ...
		    <div style="margin-bottom:15px;">
                ...
                <div style="padding-top:5px;">
                    ...
                    <i-select v-model="qry.schoolId" placeholder="请选择校区" style="width:200px;" clearable="true">
                        <i-option v-for="item in schoolIdSuggestDataList" v-bind:value="item.id" v-bind:key="item.id">{{ item.name }}</i-option>
                    </i-select>
                    <!-- <i-input placeholder="编号" v-model="qry.no" style="width:200px;"></i-input> -->
