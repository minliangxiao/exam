    ...
    <body>
		<div style="padding: 10px;" id="app">
		    <i-form ref="modelData" model="modelData" rules="ruleValidate" label-width="80">
                ...
                <Row>
                    <i-col span="24">
                        <Form-item label="试题"><span>{{modelData.question.name}}</span></Form-item>
                    </i-col>
                </Row>
                <Row>
                    <i-col span="24">
                ...
                <Row>
                    <i-col span="24">
                        <Form-item label="正确答案"><span>{{modelData.correctAnswer}}</span></Form-item>
                    </i-col>
                </Row>
                <Row>
                    <i-col span="24">
                        <Form-item label="答案"><span>{{modelData.answer}}</span></Form-item>
                    </i-col>
                </Row>
                <Row>
                    <i-col span="24">
                        <Form-item label="是否正确"><span>{{modelData.isRight|formatBoolean}}</span></Form-item>
                    </i-col>
                </Row>
                <Row>
                    <i-col span="24">
