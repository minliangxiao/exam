		    ...
		    <div style="margin-bottom:15px;">
                ...
                <div style="padding-top:5px;">
                    ...
                    <i-select v-model="qry.studentId" placeholder="请选择学生" style="width:200px;" clearable="true">
                        <i-option v-for="item in studentIdSuggestDataList" v-bind:value="item.Id" v-bind:key="item.Id">{{ item.Name }}</i-option>
                    </i-select>
                     -->
...
//                            { title: '学生', render: (h, params) => { return params.row.student.name } },
...
//                            { title: '正确数量', render: (h, params) => { return renderNumberWithThousands(h, params.row.rightQty); } },
                            { title: '错题数量', render: (h, params) => { return renderNumberWithThousands(h, params.row.errorQty); } },
                            { title: '成绩', render: (h, params) => { return renderNumberWithThousands(h, params.row.score); } },
                            { title: '最高分', render: (h, params) => { return renderNumberWithThousands(h, params.row.subjectMaxScore); } },
                            { title: '最低分', render: (h, params) => { return renderNumberWithThousands(h, params.row.subjectMinScore); } },
