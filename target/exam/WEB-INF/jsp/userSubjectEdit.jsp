        ...
        <tabs>
            ...
            <!-- 
                <Form-item label="用户" prop="userId">
                    <i-select v-model="modelData.userId" placeholder="请选择用户">
                        <i-option v-for="item in userIdSuggestDataList" :value="item.id" :key="item.id">{{ item.name }}</i-option>
                    </i-select>
                </Form-item>
                 -->
                <Form-item label="课程" prop="subjectId">
                    <i-select v-model="modelData.subjectId" placeholder="请选择课程">
                ...
                saveData: function () {
                    ...
                    this.$refs.modelData.validate((valid) => {
                        if (valid) {
                            ...
                            common.callApi({
                                url: "userSubject/save", data: me.modelData,
                                cb: function (r) {
                                    me.postIng = false;
