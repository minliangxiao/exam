...
<html>
    <head>
		...
		<base href="<%=basePath%>">  
        <title>【QuestionInTestpaper】管理</title>
    ...
    <body>
		<div style="padding: 10px;" id="app">
		    <fieldset class="layui-elem-field layui-field-title" style="margin-top: 20px;">
		        <legend>【QuestionInTestpaper】管理</legend>
		    </fieldset>
		    <div style="margin-bottom:15px;">
                ...
                <div style="padding-top:5px;">
                    ...
                    <i-select v-model="qry.testpaperId" placeholder="请选择【testpaperId】" style="width:200px;" clearable="true">
                ...
                (function () {
                    ...
                    methods: {
                        ...
                        editItem: function (item) {
                            var url = "questionInTestpaper/edit";
                            if (item)
                                url = url + "?id=" + item.id;
                            this.openWin(url);
                        },
                        displayItem: function (item) {
                            this.openWin("questionInTestpaper/show?id=" + item.id);
                        },
                        //删除数据
                        deleteItem: function (item) {
                            ...
                            layer.confirm('删除后将无法恢复，确认要删除吗？', { icon: 2, title: '提示' }, function (index) {
                                common.callApi({
                                    url: "questionInTestpaper/delete"
                                    , data: { id: item.id }
                                    , cb: function (r) {
                                        me.getData();
