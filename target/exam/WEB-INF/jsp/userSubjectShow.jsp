    ...
    <body>
		<div style="padding: 10px;" id="app">
		    <i-form ref="modelData" model="modelData" rules="ruleValidate" label-width="80">
		        <tabs>
		            <tab-pane label="我的课程信息">
                <Row>
                    <i-col span="24">
                        <Form-item label="学生"><span>{{modelData.User.name}}</span></Form-item>
                    </i-col>
                </Row>
                <Row>
                    <i-col span="24">
                ...
                <Row>
                    <i-col span="24">
                        <Form-item label="课程简介"><span>{{modelData.Subject.intro}}</span></Form-item>
                    </i-col>
                </Row>
